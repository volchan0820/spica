...
<body>
  ...
  <div class="container">
    ...
    <div class="spica-logo-main">
      ...
      <img src="/img/spiica-logo-top.png" alt="spica logo" />
    </div>
  </div>
<p>
  癒しがあなたを解き放つ<br>
  仕事、子育て、勉強などのストレスから解き放たれ、<br>
  ひとときだけでも寛いで欲しい。<br>
  西海岸の風を感じられる店内で、<br>
  ドリップコーヒーとミニケーキをご用意してお待ちしています。<br>
  自分をリセットして新しい自分に出会える場所。<br>
  私達は、そんなサロンでありたいと思っています。
</p>
  <p>テスト<br>シンプルなデザインの耳鼻咽喉科のサイト。<br>可愛らしい猿(？)のイラストが印象的です。<br>ページトップボタンはCSSアニメーションを使い、<br>見た目にも可愛いデザインになっています。<br>思わず押しちゃいます。</p>
  <p>テスト<br>シンプルなデザインの耳鼻咽喉科のサイト。<br>可愛らしい猿(？)のイラストが印象的です。<br>ページトップボタンはCSSアニメーションを使い、<br>見た目にも可愛いデザインになっています。<br>思わず押しちゃいます。</p>
